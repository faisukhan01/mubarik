...
const schools = [
  { label: 'Mubarik Science Academy', href: '#' },
  { label: 'Mubarik Educare School', href: '#' },
];
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-4">
            ...
            <p className="text-white/45 text-sm leading-relaxed max-w-xs mb-6">
              A committed educational institution providing quality education with a focus on academic excellence, scientific thinking, and character development.
            </p>
            {/* Social */}
          ...
          {/* Schools */}
          <div className="lg:col-span-2">
            <h4 className="text-xs font-semibold tracking-wider uppercase text-white/60 mb-4">Schools</h4>
            <ul className="space-y-2.5">
              {schools.map((item) => (
                <li key={item.label}>
                  <Link href={item.href} className="text-sm text-white/45 hover:text-white transition-colors">
          ...
          <div className="sm:col-span-2 lg:col-span-4">
            ...
            <ul className="space-y-3 text-sm text-white/45">
              ...
              <li>
                <a href="mailto:info@mubarik.edu.pk" className="hover:text-white transition-colors">
                  info@mubarik.edu.pk
                </a>
              </li>
              <li>
                [Campus Address — Placeholder]<br />
                Pakistan
              </li>
            </ul>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-site py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-white/30">
            &copy; {new Date().getFullYear()} Mubarik Science Academy. All rights reserved.
          </p>
          <p className="text-xs text-white/30">
            Mubarik Educational System
          </p>
        </div>
      </div>
    </footer>
